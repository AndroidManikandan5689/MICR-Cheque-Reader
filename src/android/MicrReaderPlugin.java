package cordova-plugin-micrreader;
 ...
 */
public class MicrReaderPlugin extends CordovaPlugin {
	public static final String DATA_PATH = Environment.getExternalStorageDirectory().toString() + "/OCRFolder/";
    private static final String TAG = "MicrReaderPlugin";
    private String lang = "micr";
